...
1) Simple Alert: A simple alert displays a message and an OK button.
    It's used to display a message to the user.
2) Confirmation Alert: A confirmation alert displays a message and two buttons, OK and Cancel.
    It's used to confirm the user's choice.
3) Prompt Alert: A prompt alert displays a message and a textbox for the user to enter a value. 
...
driver.find_element(By.CSS_SELECTOR, 'button#alertButton').click()
time.sleep(5)
