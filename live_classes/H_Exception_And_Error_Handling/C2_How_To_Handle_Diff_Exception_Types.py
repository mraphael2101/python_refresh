...
def funny_division(arg1):
    try:
        ...
        print("ZeroDivisionError -> Mathematicians are always trying to find answers to interesting math problems")
    except TypeError:
        return "TypeError -> Enter a numerical value"
    except ValueError:
        print("ValueError -> No, No, not 42")
        # raise # This keyword will raise the exception again
