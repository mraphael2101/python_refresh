...
driver.find_element(By.CSS_SELECTOR, "b#topic+input").send_keys("text")

# switch to first inner frame inside first frame
driver.switch_to.frame(0)
...
animals_dropdown = Select(driver.find_element(By.CSS_SELECTOR, "#animals"))
animals_dropdown.select_by_value("babycat")
time.sleep(5)
driver.switch_to.default_content()
print(driver.find_element(By.CSS_SELECTOR, "h1.breadcrumb-item").text)
driver.quit()
